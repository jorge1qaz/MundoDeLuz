...
namespace MundoDeLuz.Presentation.Messages
{
    ...
    {
        static string headerRegistroUsuario = "¡Error inesperado!";
        static string bodyRegistroUsuario = "Se ha producido un error inesperado, contacte con el admistrador..."; // Completar mensaje
